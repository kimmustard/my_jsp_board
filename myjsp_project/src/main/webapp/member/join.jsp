			...
			<div class="memberAdd">
				...
				<form action="/mem/register" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" name="id" class="form-control" placeholder="ID" id="inputDefault">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" name="age" class="form-control" placeholder="AGE" id="inputDefault">
					</div>
					<div class="form-group">
						<label for="exampleTextarea" class="form-label mt-4"><span class="memberText"> 자기소개
							</span></label>
						<textarea class="form-control" name="introduce" id="exampleTextarea" rows="3"></textarea>
					</div>
					<div class="form-group">
